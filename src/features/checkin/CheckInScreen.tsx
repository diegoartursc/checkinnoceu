// src/features/checkin/CheckInScreen.tsx
import React, { memo, useState, useMemo } from 'react';
import { CheckCircle, Sun, Play, ArrowRight, X } from 'lucide-react';
import Button from '@/components/ui/Button';
import CatcherGame from '@/features/game/CatcherGame';
...
const CheckInScreen = memo(({ currentDay }: CheckInScreenProps) => {
  const { completeDay, lastCompletedDay } = useUserProgress();
  ...
  const isCompletedToday = lastCompletedDay >= currentDay;
